...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"national_level1","label":"Country","min_zoom":4,"max_zoom":6,"staticBorders":true},{"subfolder":"regions_1","label":"Regions1","min_zoom":6,"max_zoom":8,"staticBorders":true},{"subfolder":"regions_3","label":"Regions3","min_zoom":9,"max_zoom":12,"staticBorders":true}],
      precision: precision,
